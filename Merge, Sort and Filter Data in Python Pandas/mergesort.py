...
# plt.suptitle('tempYearly.csv')
# plt.title('Queried Temperature Data')
# plt.show()

# df_rain.plot.scatter(x='Year', y='Rainfall', label='Temperature and Rainfall')
# plt.suptitle('RainYearly.csv')
# plt.title('Rain Data by Year')
# plt.show()
...
# plt.suptitle('rainYearly.csv')
# plt.title('Queried Rainfall Data')
# plt.show()
