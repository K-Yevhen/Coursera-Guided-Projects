...
# starting pygame function, initialize all the import function to use it
pygame.init()

# set the title of the game, the screen mode and adding the win image
display.set_caption('My First Py Game')
